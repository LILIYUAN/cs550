...
ssh compute-0-0 "$BASEDIR/obtain_server compute-0-0 $BASEDIR/mesh-10node/compute-0-0.peers $BASEDIR/data/share0" &
ssh compute-0-1 "rm -rf /tmp/indsvr"
ssh compute-0-1 "$BASEDIR/obtain_server compute-0-1 $BASEDIR/mesh-10node/compute-0-1.peers $BASEDIR/data/share1" &
...
ssh compute-0-6 "$BASEDIR/obtain_server compute-0-6 $BASEDIR/mesh-10node/compute-0-6.peers $BASEDIR/data/share6" &
ssh compute-0-7 "rm -rf /tmp/indsvr"
ssh compute-0-7 "$BASEDIR/obtain_server compute-0-7 $BASEDIR/mesh-10node/compute-0-7.peers $BASEDIR/data/share7" &
