...
ssh compute-0-6 "$BASEDIR/obtain_server compute-0-6 $BASEDIR/star-10node/compute-0-6.peers $BASEDIR/data/share6" &
ssh compute-0-7 "rm -rf /tmp/indsvr"
ssh compute-0-7 "$BASEDIR/obtain_server compute-0-7 $BASEDIR/star-10node/compute-0-7.peers $BASEDIR/data/share7" &
ssh compute-0-8 "rm -rf /tmp/indsvr"
ssh compute-0-8 "$BASEDIR/obtain_server compute-0-8 $BASEDIR/star-10node/compute-0-8.peers $BASEDIR/data/share8" &
ssh compute-0-9 "rm -rf /tmp/indsvr"
ssh compute-0-9 "$BASEDIR/obtain_server compute-0-9 $BASEDIR/star-10node/compute-0-9.peers $BASEDIR/data/share9" &
